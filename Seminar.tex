...
and to deal with probability. In 1929 the British mathematician Bertrand
Russell stated
...
In the following, I will explain in more detail what is meant by false
confidence, how and why it may lead to problems. To motivate this
discussion, I will introduce key ideas from imprecise probability theory
and fiducialism, and then explore their connection to inferential
models.
...
\(A\), without any knowledge of \(B\). Based on such a reading, the
above conclusion seems quite reasonable - even though such a perspective
might be rather uncommon in this context. Rather, one would interpret
such an educated guess as a quantification of the strength of belief.
Such an educated guess would more likely be meant as a quantification of
...
by intuition, an experts opinion or a known distribution. A
